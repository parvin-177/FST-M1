...
public class Activity5 {
    ...
    public void sendSMSTest() {
        ...
        driver.findElement(AppiumBy.id("recipient_text_view")).sendKeys("8007779885");
        // Press ENTER
        ...
        // Enter text to send
        driver.findElement(AppiumBy.id("compose_message_text")).sendKeys("Hello Bharat from Appium");
        // Press Send
        driver.findElement(AppiumBy.accessibilityId("Send SMS")).click();

        // Verify the SMS message
        String smsMessageTxt = driver.findElement(AppiumBy.id("message_text")).getText();
        Assert.assertEquals(smsMessageTxt, "Hello Bharat from Appium");
    }
